...
up: ## Inicia os containers do PHP e MYSQL
	...
	printf "\n\n\e[42m\e[30m meece \e[0m \e[32mpronto para uso! \e[0m-> \e[94m\e[4mhttps://dev.zupah.com.br\e[0m\n\n"
...
bash: ## Bash dentro do container PHP
	docker exec -ti zupah-php bash

bash-mysql: ## Bash dentro do container PHP
	docker exec -ti zupah-mysql bash

mysql: ## Entra direto no mysql do container
	docker exec -ti zupah-mysql mysql -uroot -proot
